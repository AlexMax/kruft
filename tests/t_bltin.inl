...
TEST(bltin, kr_bswap64_MACRO)
{
    ...
    SKIP();
#else  /* !defined(UINT64_MAX) */
    EXPECT_UINTEQ(UINT64_C(0xEFCDAB8967452301), kr_bswap64(0x0123456789ABCDEF));
#endif /* !defined(UINT64_MAX) */
}
...
TEST(bltin, kr_rol64_MACRO)
{
    ...
    SKIP();
#else  /* !defined(UINT64_MAX) */
    EXPECT_XINTEQ(UINT64_C(0x2a99ff800799aa80), kr_rol64(0x05533ff000f33550, 3));
    EXPECT_XINTEQ(UINT64_C(0x001e66aa00aa67fe), kr_rol64(0x05533ff000f33550, 29));
    EXPECT_XINTEQ(UINT64_C(0x0799aa802a99ff80), kr_rol64(0x05533ff000f33550, 35));
    EXPECT_XINTEQ(UINT64_C(0x00aa67fe001e66aa), kr_rol64(0x05533ff000f33550, 61));
    EXPECT_XINTEQ(UINT64_C(0x05533ff000f33550), kr_rol64(0x05533ff000f33550, 0));
#endif /* !defined(UINT64_MAX) */
}
...
TEST(bltin, kr_ror64_MACRO)
{
    ...
    SKIP();
#else  /* !defined(UINT64_MAX) */
    EXPECT_XINTEQ(UINT64_C(0x00aa67fe001e66aa), kr_ror64(0x05533ff000f33550, 3));
    EXPECT_XINTEQ(UINT64_C(0x0799aa802a99ff80), kr_ror64(0x05533ff000f33550, 29));
    EXPECT_XINTEQ(UINT64_C(0x001e66aa00aa67fe), kr_ror64(0x05533ff000f33550, 35));
    EXPECT_XINTEQ(UINT64_C(0x2a99ff800799aa80), kr_ror64(0x05533ff000f33550, 61));
    EXPECT_XINTEQ(UINT64_C(0x05533ff000f33550), kr_ror64(0x05533ff000f33550, 0));
#endif /* !defined(UINT64_MAX) */
}
