...
TEST(bit, kr_rotl32)
{
    ...
    EXPECT_UINTEQ(0x001e66aa, kr_rotl32(0x00f33550, 29));
    EXPECT_UINTEQ(0x00f33550, kr_rotl32(0x00f33550, 0));
}

TEST(bit, kr_rol32_MACRO)
{
    EXPECT_UINTEQ(0x0799aa80, kr_rol32(0x00f33550, 3));
    EXPECT_UINTEQ(0x001e66aa, kr_rol32(0x00f33550, 29));
    EXPECT_UINTEQ(0x00f33550, kr_rol32(0x00f33550, 0));
}

TEST(bit, kr_rotl64)
{
    EXPECT_UINT64EQ(UINT64_C(0x2a99ff800799aa80), kr_rotl64(UINT64_C(0x05533ff000f33550), 3));
    EXPECT_UINT64EQ(UINT64_C(0x001e66aa00aa67fe), kr_rotl64(UINT64_C(0x05533ff000f33550), 29));
    EXPECT_UINT64EQ(UINT64_C(0x0799aa802a99ff80), kr_rotl64(UINT64_C(0x05533ff000f33550), 35));
    EXPECT_UINT64EQ(UINT64_C(0x00aa67fe001e66aa), kr_rotl64(UINT64_C(0x05533ff000f33550), 61));
    EXPECT_UINT64EQ(UINT64_C(0x05533ff000f33550), kr_rotl64(UINT64_C(0x05533ff000f33550), 0));
}

TEST(bit, kr_rol64_MACRO)
{
    EXPECT_UINT64EQ(UINT64_C(0x2a99ff800799aa80), kr_rol64(UINT64_C(0x05533ff000f33550), 3));
    EXPECT_UINT64EQ(UINT64_C(0x001e66aa00aa67fe), kr_rol64(UINT64_C(0x05533ff000f33550), 29));
    EXPECT_UINT64EQ(UINT64_C(0x0799aa802a99ff80), kr_rol64(UINT64_C(0x05533ff000f33550), 35));
    EXPECT_UINT64EQ(UINT64_C(0x00aa67fe001e66aa), kr_rol64(UINT64_C(0x05533ff000f33550), 61));
    EXPECT_UINT64EQ(UINT64_C(0x05533ff000f33550), kr_rol64(UINT64_C(0x05533ff000f33550), 0));
}
...
TEST(bit, kr_rotr32)
{
    EXPECT_UINTEQ(0x001e66aa, kr_rotr32(0x00f33550, 3));
    EXPECT_UINTEQ(0x0799aa80, kr_rotr32(0x00f33550, 29));
    EXPECT_UINTEQ(0x00f33550, kr_rotr32(0x00f33550, 0));
}

TEST(bit, kr_ror32_MACRO)
{
    EXPECT_UINTEQ(0x001e66aa, kr_ror32(0x00f33550, 3));
    EXPECT_UINTEQ(0x0799aa80, kr_ror32(0x00f33550, 29));
    EXPECT_UINTEQ(0x00f33550, kr_ror32(0x00f33550, 0));
}

TEST(bit, kr_rotr64)
{
    EXPECT_UINT64EQ(UINT64_C(0x00aa67fe001e66aa), kr_rotr64(UINT64_C(0x05533ff000f33550), 3));
    EXPECT_UINT64EQ(UINT64_C(0x0799aa802a99ff80), kr_rotr64(UINT64_C(0x05533ff000f33550), 29));
    EXPECT_UINT64EQ(UINT64_C(0x001e66aa00aa67fe), kr_rotr64(UINT64_C(0x05533ff000f33550), 35));
    EXPECT_UINT64EQ(UINT64_C(0x2a99ff800799aa80), kr_rotr64(UINT64_C(0x05533ff000f33550), 61));
    EXPECT_UINT64EQ(UINT64_C(0x05533ff000f33550), kr_rotr64(UINT64_C(0x05533ff000f33550), 0));
}

TEST(bit, kr_ror64_MACRO)
{
    EXPECT_UINT64EQ(UINT64_C(0x00aa67fe001e66aa), kr_ror64(UINT64_C(0x05533ff000f33550), 3));
    EXPECT_UINT64EQ(UINT64_C(0x0799aa802a99ff80), kr_ror64(UINT64_C(0x05533ff000f33550), 29));
    EXPECT_UINT64EQ(UINT64_C(0x001e66aa00aa67fe), kr_ror64(UINT64_C(0x05533ff000f33550), 35));
    EXPECT_UINT64EQ(UINT64_C(0x2a99ff800799aa80), kr_ror64(UINT64_C(0x05533ff000f33550), 61));
    EXPECT_UINT64EQ(UINT64_C(0x05533ff000f33550), kr_ror64(UINT64_C(0x05533ff000f33550), 0));
}
